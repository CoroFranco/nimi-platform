<x-applayout>
    <div class="flex-grow p-6 md:overflow-y-auto md:p-12 bg-gray-100">
        <div class="max-w-4xl mx-auto">
            <h1 class="text-4xl font-bold mb-8 text-gray-800">Crear Nuevo Curso</h1>
            ...
            <form id="course-form" action="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="title" id="title" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--highlight-color)] focus:border-[var(--highlight-color)]">
                        </div>
                        <div>
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" name="price" id="price" step="0.01" min="0" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--highlight-color)] focus:border-[var(--highlight-color)]">
                        </div>
                        <div>
                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <div class="mt-2">
                        <label for="thumbnail" class="block text-sm font-medium text-gray-700 mb-2">Selecciona una imagen</label>
            ...
            const moduleHtml = `
                <div id="module-${moduleCount}" class="module bg-gray-100 rounded-lg p-6 mb-4 relative">
                    ...
                    <div>
                        ...
                        <input type="text" name="modules[${moduleCount}][title]" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--highlight-color)] focus:border-[var(--highlight-color)]">
                    </div>
                    <div class="mt-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Descripción del Módulo</label>
                        <textarea name="modules[${moduleCount}][description]" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--highlight-color)] focus:border-[var(--highlight-color)]"></textarea>
                    </div>
                    <div class="mt-4">
        ...
        function addLesson(moduleId) {
            ...
            const lessonHtml = `
                <div class="lesson bg-white rounded-lg p-4 relative">
                    <button type="button" class="absolute top-2 right-2 text-red-500 hover:text-red-700" onclick="this.closest('.lesson').remove()">
                    ...
                    <div>
                        ...
                        <input type="text" name="modules[${moduleId}][lessons][${lessonCount}][title]" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--highlight-color)] focus:border-[var(--highlight-color)]">
                    </div>
                    <div class="mt-2">
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tipo de Contenido</label>
                        <select name="modules[${moduleId}][lessons][${lessonCount}][type]" required class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--highlight-color)] focus:border-[var(--highlight-color)]" onchange="showContentField(this, ${moduleId}, ${lessonCount})">
                    ...
                    <div class="mt-2">
                        ...
                        <textarea name="modules[${moduleId}][lessons][${lessonCount}][description]" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[var(--highlight-color)] focus:border-[var(--highlight-color)]"></textarea>
                    </div>
        ...
        function addQuizQuestion(moduleId, lessonId) {
            ...
            const questionHtml = `
                <div class="quiz-question bg-gray-50 p-4 rounded-md mt-4">
                    ...
                    <input type="text" name="modules[${moduleId}][lessons][${lessonId}][quiz][${questionCount}][question]" placeholder="Pregunta" class="w-full px-3 py-2 border border-gray-300 rounded-md mb-2">
                    <textarea name="modules[${moduleId}][lessons][${lessonId}][quiz][${questionCount}][answers]" rows="4" placeholder="Opciones (una por línea)" class="w-full px-3 py-2 border border-gray-300 rounded-md mb-2"></textarea>
                    <input type="text" name="modules[${moduleId}][lessons][${lessonId}][quiz][${questionCount}][correct]" placeholder="Respuesta correcta" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                </div>
            `;
